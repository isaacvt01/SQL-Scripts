...
![create_database](img/create_tabke_stores.png)

#### 3. Next step is to insert data on the table stores.
![create_database](img/insert_data_stores.png)
